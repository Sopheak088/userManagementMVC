...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        type = ResourceType.Add( "Audios" );
		type.Url = BaseUrl + "Audios/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Audios/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "mid", "mov", "mp3" };
		type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Videos" );
		type.Url = BaseUrl + "Videos/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Videos/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "avi", "mp4" };
		type.DeniedExtensions = new string[] { };
