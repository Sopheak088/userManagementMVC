...
namespace WebMvc.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public ActionResult RememberBrowser()
        {
            ...
            return RedirectToAction("Index", "ApplicationManage");
        }
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            return new UserController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "ApplicationManager"), User.Identity.GetUserId());
        }
